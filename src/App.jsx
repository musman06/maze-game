...
import { OrbitControls, Text } from "@react-three/drei"; //react fiber helper library
...
const App = () => {
  ...
  const xAxis = 42;
  const zAxis = 33;
  const startPosition = new Vector3(xAxis, -0.7, -zAxis);
  const finishPosition = new Vector3(-xAxis, -0.7, zAxis);
